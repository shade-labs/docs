...
<CardGroup>
  <Card title="Learning Shade" icon="sliders" href="/introduction">
    Learn the basics of searching, adding files, removing, and how to leverage the full power of Shade. (Coming Soon)
  </Card>
