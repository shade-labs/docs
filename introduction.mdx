...
<CardGroup>
  <Card title="Using Shade" icon="sliders" href="/start-guide/use-shade">
    Learn the basics of searching, adding files, removing, and how to leverage the full power of Shade.
  </Card>
  <Card title="Understand Shade's Engines" icon="engine" href="/indexing-assets/engines">
    Grasp and understand how Shade's AI Engines work to organize your files.
  </Card>
</CardGroup>
