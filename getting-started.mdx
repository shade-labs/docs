...
Log in or create your Shade account via the Sign in With Email Address and Password (more authentication methods to come soon). If you're using this in a studio, skip to studio authentication. 
...
Once files and folders are added, Shade’s backend process will begin indexing your assets and using AI to autocatalogue and make your assets searchable for you. This is now a time where you can sit back and wait as you begin to see your assets visualize onto your screen.
...
Here you can see that Shade has displayed all my assets that I indexed above
